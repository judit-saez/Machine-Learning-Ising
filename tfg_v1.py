...
for i in range(0, 1): 
    os.mkdir('C:\\Users\\judit\\Desktop\\J1D\\TFG\\div_temps\\_' + str(Nsites) + '_') #enlloc de div_temps aixo era v1
    ...
    """ plt.plot(Mlist, linestyle='none', marker='.', c='black')
        ...
        plt.savefig('C:\\Users\\judit\\Desktop\\J1D\\TFG\\v1\\_' + str(i) + '_\\'+ str(figname), dpi=1000)
        plt.show()
    ...
    plt.ylabel('<Magnetization>[$\mu$]')
    plt.savefig('C:\\Users\\judit\\Desktop\\J1D\\TFG\\v1\\_' + str(i) + '_\\'+ "(" + str(i) + ")" + 'MvsT.png', dpi=1000)
    plt.show()

#creating a csv and writing the output 
    d = [TL, OList, LMaver]
    export_data = zip_longest(*d, fillvalue = '')
    with open('C:\\Users\\judit\\Desktop\\J1D\\TFG\\v1\\_' + str(i) + '_\\'+ "(" + str(i) + ") " + "Output("+ str(i) + ")_"+ str(Nsites) + "grid.csv", 'w', encoding="ISO-8859-1", newline='') as myfile:
